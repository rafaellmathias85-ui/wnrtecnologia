      ...
      <div className="relative mx-auto flex min-h-[calc(92vh-8rem)] max-w-7xl items-center px-4 pb-16 sm:px-6 lg:px-8">
        <div className="max-w-4xl">
          <div className="mb-7 inline-flex items-center gap-2 rounded-lg border border-cyan/30 bg-cyan/10 px-3 py-2 text-sm font-semibold text-cyan">
            ...
            Divisao tech da Winner Tecnologia
          </div>

          <h1 className="max-w-5xl font-display text-5xl font-bold leading-tight tracking-normal text-white sm:text-6xl lg:text-7xl">
            Tecnologia, Automacao e IA para transformar seu negocio
          </h1>

          <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
            A WNR Tecnologia cria plataformas, automatizacoes e produtos com inteligencia artificial para
            acelerar operacoes, reduzir tarefas repetitivas e abrir novos caminhos digitais para empresas.
          </p>
          ...
          <div className="mt-12 grid max-w-3xl gap-3 sm:grid-cols-3">
            {[
              ...
              { icon: ShieldCheck, label: "Seguranca por design" },
              { icon: Sparkles, label: "Automacao sob medida" }
            ].map((item) => (
